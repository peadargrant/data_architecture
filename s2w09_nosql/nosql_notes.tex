...
According to the CAP theorem: impossible to have both consistency and availability in a partition-tolerent distributed system.
Already met the ACID consistency model.
ACID compliance prefers consistency over availability.

\citet{pritchett:2008:base} proposed an alternative, BASE:
